...
export function VehicleCard({ index, vehicle, categories }: VehicleCardProps) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border-2 border-ink bg-card transition-transform duration-200 motion-reduce:transition-none supports-[hover:hover]:hover:-translate-y-1">
      ...
      <div className="flex flex-1 flex-col gap-5 p-5 sm:p-6">
        ...
        <dl className="mt-auto grid grid-cols-2 gap-3 border-t border-dashed border-ink/30 pt-4 text-sm">
          <div>
